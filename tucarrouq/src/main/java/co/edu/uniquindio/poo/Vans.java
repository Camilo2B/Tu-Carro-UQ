...
public class Vans extends Vehiculo{
    ...
    public Vans(String abs, int airbags, String aireAcondicionado, String camaraReversa, int capacidadMaletero, int pasajeros, int puertas, String marca, String uso, String modelo, String cambios, String velocidadMaxima, String cilindraje) {
