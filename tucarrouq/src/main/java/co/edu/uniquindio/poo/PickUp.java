...
public class PickUp extends Vehiculo{
    ...
    public PickUp(String abs, int airbags, String aireAcondicionado, String camaraReversa, int capacidadCajaCarga, String cuatroxcuatro, int pasajeros, int puertas, String marca, String uso, String modelo, String cambios, String velocidadMaxima, String cilindraje) {
