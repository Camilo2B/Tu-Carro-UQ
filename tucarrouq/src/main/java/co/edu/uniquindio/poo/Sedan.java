...
public class Sedan extends Vehiculo {
    ...
    public String toString() {
        return "Sedan [pasajeros=" + pasajeros + ", puertas=" + puertas + ", capacidadMaletero=" + capacidadMaletero
                ...
                + ", asistentePermanenciaCarril=" + asistentePermanenciaCarril + "]"+super.toString();
    }
